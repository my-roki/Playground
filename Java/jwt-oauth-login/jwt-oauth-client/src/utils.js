const BACKEND_PORT = process.env.REACT_APP_BACKEND_PORT === null ? "" : `:${process.env.REACT_APP_BACKEND_PORT}`;
const BACKEND_URL = `${window.location.protocol}//${window.location.hostname}${BACKEND_PORT}`;
const FRONTEND_PORT = process.env.REACT_APP_FRONTEND_PORT === null ? "" : `:${process.env.REACT_APP_FRONTEND_PORT}`;
